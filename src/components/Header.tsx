  ...
  return (
    <header className={headerSm}>
      <div className="flex   justify-between item-center px-4 py-2  w-full sm:justify-center">
        <div className=" text-primary-100 font-semibold  tracking-wider  text-2xl text-center lg:text-3xl font-iceland  -mt-1 sm:-mt-0">
          Ramy Niranjan
        </div>
...
// relative h-6 w-32 lg:w-48 sm:h-8
//  const svgVariants = {
//    hidden: {
//      opacity: 0,
//      pathLength: 0,
